...
export async function payForResource(amount, recipient) {
  if (!recipient) throw new Error('Recipient address is required for x402 settlement');
  console.log(chalk.bold.cyan(`\n   [X402 GATEWAY] Initiating Peer-to-Peer Settlement: ${amount} USDC`));
  console.log(chalk.dim(`   [PROTOCOL] Agent Identity: ${recipient}`));
